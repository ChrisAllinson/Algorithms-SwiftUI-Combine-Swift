...
struct ReverseStringSimpleView: View {
    private var viewModel: ReverseStringSimpleManagable = ReverseStringSimpleViewModel()
    ...
    var body: some View {
        ...
        .navigationTitle("Reverse_String_Simple")
    }
}

struct ReverseStringSimpleView_Previews: PreviewProvider {
